    ...
    return (
        <div className="form-container">
            ...
            <form className="form" method="post">
                <FormField label="Name" name="name" changeHandler={handleFormChange} />
                <FormField label="Email address" name="email" changeHandler={handleFormChange} />
                <FormField label="Username" name="username" changeHandler={handleFormChange} />
                <FormField label="Password" name="password" hideContents changeHandler={handleFormChange} />

                <div className="form-links">
                    <Link className="link" to="/login">Login instead?</Link>
                    <input className="primary-button" type="submit" value="Sign Up" onChange={handleFormChange} />
                </div>
            </form>
        </div>
    );
